...
VOLA = 0#0.001#1e-9#0 #0.001#0.0001#0.001#0.01#1e-9#0.01#.00001 #0.001# volatilità
INV = 100 # inventario
PASSI = 10 #discretizzazione
STEP = 15*5 # abbassa la epsilon ogni 100 azioni compiute
NUMIT = 2#5_000 # traiettorie di train, quelle di test sono sempre la meta', il numero totale delle azioni compiute in train sarà NUMIT x PASSI
